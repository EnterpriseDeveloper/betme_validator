...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in cosmos/protocolpool/v1/tx_pb2_grpc.py depends on'
...
def add_MsgServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('cosmos.protocolpool.v1.Msg', rpc_method_handlers)
