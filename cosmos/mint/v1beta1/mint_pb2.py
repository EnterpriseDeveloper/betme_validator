...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PARAMS'].fields_by_name['max_supply']._loaded_options = None
  ...
  _globals['_PARAMS']._serialized_end=759
