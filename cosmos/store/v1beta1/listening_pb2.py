...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STOREKVPAIR']._serialized_end=215
  _globals['_BLOCKMETADATA']._serialized_start=218
  _globals['_BLOCKMETADATA']._serialized_end=465
